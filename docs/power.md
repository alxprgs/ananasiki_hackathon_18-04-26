...
| [Arduino UNO](docs/A000066-datasheet.pdf) | 5 V | ≈200 mA | 1 | | 1 Вт (5V * 0.2A * 1шт) |
| [URM37](docs/urm37.pdf) (ультразвуковой датчик расстояния) | 5 V | ≈50 mA | 2 | | 0,5 Вт (5V * 0.05A * 2шт) | 
| [MTR-SERVO-FT5519M](docs/FT5519M.pdf) (сервопривод) | 5 V | ≈1 A | 2 | Очень плохо, но будем сокращать в 2 раза от предположительного наминала из-за перехода лимитов. Поэтому потребляемый ток будем считать за ≈500 mA | 5 Вт (5V * 0.5A * 2шт) |
| Hi W001 | 5 V | ≈200 mA | 1 | | 1 Вт (5V * 0.2A * 1шт) |
| [Raspberry Pi 4B](docs/raspberrypi4b_docs.pdf) | 5 V | ≈3 A | 1 | | 15 Вт (5V * 3A * 1шт) |
